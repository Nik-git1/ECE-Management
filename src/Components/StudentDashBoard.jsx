...
const StudentDashBoard = () => {
  const tableData = [
    { id: 1, equipmentName: 'Laptop', quantity: 2, lastReturnDate: '2023-10-25' },
    { id: 2, equipmentName: 'Calculator', quantity: 1, lastReturnDate: '2023-10-27' },
];
    const columnNames = ['S.No', 'Equipment Name', 'Quantity', 'Last date of Return', 'Action'];
    const returnedHeader = ['S.No', 'Equipment Name', 'Quantity', 'Last date of Return', 'Status'];
